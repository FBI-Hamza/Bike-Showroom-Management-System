...
public class viewCustomerGui extends JFrame {
    ...
    public viewCustomerGui() {
        ...
        bikeOwner.setForeground(Color.RED);
        ownerName.setForeground(Color.RED);
        bikePlate.setForeground(Color.RED);
        ownerCNIC.setForeground(Color.RED);
        ownerAge.setForeground(Color.RED);
        buyingDate.setForeground(Color.RED);
