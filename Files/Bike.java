...
public class Bike extends Vehicle implements Serializable {
    ...
    public static Bike checkStock(String numberPlate) {
    ...
    public static Bike searchByType(String numberPlate) {
        ObjectInputStream ois = null;
        try {
            ois = new ObjectInputStream(new FileInputStream("soldBikes.ser"));
            while (true) {
                Bike b = (Bike) ois.readObject();
                if(b.getTypes().equalsIgnoreCase(numberPlate)){
    ...
    public static Bike SearchInSold(String numberPlate) {
        ObjectInputStream ois = null;
        try {
            ois = new ObjectInputStream(new FileInputStream("soldBikes.ser"));
            while (true) {
    ...
    public static Bike SearchGreaterThanAmount(double amount) {
        ObjectInputStream ois = null;
        try {
            ois = new ObjectInputStream(new FileInputStream("bikes.ser"));
            while (true) {
