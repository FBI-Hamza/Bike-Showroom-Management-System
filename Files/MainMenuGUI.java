...
public class MainMenuGUI extends JFrame {
    ...
    private JButton searchExpensive;
    ...
    public MainMenuGUI() {
        ...
        searchExpensive = new JButton("Search Expensive");
        exit = new JButton("Sign out");


        bikeShowroom.setForeground(Color.red);
        ...
        searchExpensive.setBackground(Color.lightGray);
        ...
        calculateBill.setBounds(450,390,180,40);
        searchExpensive.setBounds(200,450,180,40);

        tArea.setBounds(170,120,490, 380);
        exit.setBounds(450, 450, 180, 40);
        ...
        calculateBill.addActionListener(a);
        searchExpensive.addActionListener(a);
    ...
    class MyActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            else if(ae.getActionCommand().equalsIgnoreCase( "Calculate Bill")){
                frame.dispose();
                calculateBillGui g =  new calculateBillGui();
            }
            else if(ae.getActionCommand().equalsIgnoreCase( "Search Expensive")){
                frame.dispose();
                searchExpensiveGui g =  new searchExpensiveGui();
            }
            else if(ae.getActionCommand().equalsIgnoreCase( "Sign out")){
            frame.dispose();
            }
        }
    }
