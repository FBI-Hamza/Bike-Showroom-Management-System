...
public class AddBikeGui extends JFrame {
    ...
    public AddBikeGui() {
        ...
        addingBike.setForeground(Color.RED);
        bikeNumberPlate.setForeground(Color.RED);
        bikeColour.setForeground(Color.RED);
        bikePrice.setForeground(Color.RED);
        bikeCC.setForeground(Color.RED);
        bikeType.setForeground(Color.RED);
    ...
    class MyActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent ae) {
            if (ae.getActionCommand().equalsIgnoreCase("Save")) {
                ...
                if(tBikePrice.getText().isEmpty()|!(Vehicle.isPriceValid(Double.parseDouble(tBikePrice.getText())))){
                    JOptionPane.showMessageDialog(null, "Invalid Price");
                    tBikePrice.setText(null);
                }
                if(!(Vehicle.isCCValid(Double.parseDouble(tBikeCC.getText())))|tBikePrice.getText().isEmpty()){
                    JOptionPane.showMessageDialog(null, "Invalid CC");
                    tBikeCC.setText(null);
                }
                if(tBikeColour.getText().isEmpty()){
                    JOptionPane.showMessageDialog(null, "Bike should have colour.");
                    tBikeColour.setText(null);
                }
                 if(tBikeType.getText().isEmpty()){
                    JOptionPane.showMessageDialog(null, "Bike should have type.");
